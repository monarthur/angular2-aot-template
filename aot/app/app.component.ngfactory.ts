...
class _View_AppComponent0 extends import1.AppView<import0.AppComponent> {
  ...
  createInternal(rootSelector:string):import3.AppElement {
    ...
    this._text_1 = this.renderer.createText(this._el_0,'Empty Angular 2 App',(null as any));
    this._text_2 = this.renderer.createText(parentRenderNode,'\n',(null as any));
    this._el_3 = this.renderer.createElement(parentRenderNode,'h3',(null as any));
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    this.detectContentChildrenChanges(throwOnChange);
    const currVal_0:any = import4.interpolate(1,'',this.context.test,'');
